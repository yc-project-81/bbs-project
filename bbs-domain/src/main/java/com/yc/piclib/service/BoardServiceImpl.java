...
public class BoardServiceImpl implements BoardService {
    ...
    public List<BoardDomain> list() {
        ...
        for (Board p : list) {
            BoardDomain pd = new BoardDomain(p.getBoardid(), p.getBoardname(), p.getParentid());
            r.add(pd);
        }
        return r;
    }
    ...
    public PageDomain<BoardDomain> listByPage(BoardDomain boardDomain) {
        ...
        if (CommonUtils.isNotNull(boardDomain.getParentid())) {
            example.createCriteria()
                    .andLike("parentid", "%" + boardDomain.getParentid() + "%");
        }
    ...
    public void save(BoardDomain boardDomain) {
        ...
        board.setParentid(boardDomain.getParentid());
